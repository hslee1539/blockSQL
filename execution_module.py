...
def execute(cursor : sqlite3.Cursor, sql : str, tableInfo : blockSQL.sql.tool.table_info_module.TableInfo, arc4 = ARC4.new, hashFunc = hashlib.sha256, timeFunc = time.time) -> sqlite3.Cursor:
    ...
    if(funcName == "CREATE TABLE"):
        ...
        blockSQL.sql.block_module.insert(cursor, tableName, hashFunc, arc4, timeFunc)
